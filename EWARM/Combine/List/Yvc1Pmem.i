...
{
	SPICMD_E_READ_ID = 0,                                                    
	SPICMD_Q_WRITE_ENABLE,                                                   
	SPICMD_Q_WRITE_REGISTER,                                                 
	SPICMD_Q_WRITE_REGISTER2,                                                 
	SPICMD_Q_READ_STATUS_REGISTER,                                           
	SPICMD_Q_READ_CONFIGURATION_REGISTER,                                    

	SPICMD_Q_BULK_ERASE,                                                     
	SPICMD_Q_SECTOR_ERASE,                                                   
	SPICMD_Q_QUAD_PAGE_PROGRAM,                                              
	SPICMD_Q_QUAD_IO_READ,                                                   
...
U08 u08PatternMemorySettings[SPICMD_NUM][7] = {
	...
	{  0x02U, 0x03U, 0x00U, 0x03U, 0x9FU, 0x00U, 0x00U },   
	{  0x02U, 0x00U, 0x00U, 0x03U, 0x06U, 0x00U, 0x00U },  
	{  0x02U, 0x03U, 0x00U, 0x03U, 0x01U, 0x00U, 0x00U },  
	{  0x02U, 0x03U, 0x00U, 0x03U, 0xC0U, 0x00U, 0x00U },  
	{  0x02U, 0x03U, 0x00U, 0x03U, 0x05U, 0x00U, 0x00U },  
	{  0x02U, 0x03U, 0x00U, 0x03U, 0x61U, 0x00U, 0x00U },  
	{  0x02U, 0x00U, 0x00U, 0x03U, 0xC7U, 0x00U, 0x00U },   
	{  0x02U, 0x18U, 0x18U, 0x03U, 0xD8U, 0x00U, 0x00U },   
	
	{  0x02U, 0x19U, 0x18U, 0x03U, 0x32U, 0x00U, 0x00U },   
	{  0x02U, 0x81U, 0x0AU, 0x1BU, 0xEBU, 0x00U, 0x00U },  
	
	{  0x02U, 0x03U, 0x00U, 0x03U, 0xB7U, 0x00U, 0x00U },   
};
...
BOOL initPatternMemory(void)
{
	...
	writeStatusRegCommand(u32Addr, (U08)SPICMD_Q_WRITE_REGISTER, (0x40U));

	 
	 
	 
	bRet = readStatusRegCommand(u32Addr, (3000000UL));
	...
	writeStatusRegCommand(u32Addr, (U08)SPICMD_Q_WRITE_REGISTER2, (0xF0U));
	...
	if( writePtnmemCtrlRegs((U08)SPICMD_Q_QUAD_IO_READ) == 0x00 )
	{
			return 0x00;
	}
	return bRet;
...
BOOL readPatternMemory(U32 Addr, U08 *Buff, U32 Num)
{
	...
	YVC_WritePort((U08)Y643_PORT_PTNMEM_READACS, 0x00U);
	...
	while(u32RCount < Num)
	{
		...
		if(u32RCount == (Num-1UL))
		{
			...
			YVC_WritePort((U08)Y643_PORT_PTNMEM_READACS, ((0x80U) | (0x10U)));
		}
		else
		{
			 
			YVC_WritePort((U08)Y643_PORT_PTNMEM_READACS, (0x80U));
		}
		...
		Buff[u32RCount] = YVC_ReadPort((U08)Y643_PORT_PTNMEM_DATA);
...
static void waitClearFlag(U08 u08Mask)
{
	...
	do
	{
		u08ReadData = YVC_ReadPort((U08)Y643_PORT_PTNMEM_READACS);

		 
		if(u32Polling >= (3000000UL))
		{
			bRet = 0x00;
		}
	...
	} while (((u08ReadData & u08Mask) != 0U) && (bRet == 0x01));
}
...
static void writePmaRegs(U32 Addr)
{
	...
	Pma[0] = (U08)(( Addr >> (24) ) & (0x03U));
	Pma[1] = (U08)(( Addr >> (16) ) & (0xFFU));
	Pma[2] = (U08)(( Addr >> (8) ) & (0xFFU));
	Pma[3] = (U08)(( Addr                ) & (0xFFU));
...
static BOOL readStatusRegCommand(U32 Addr, U32 PollingCnt)
{
	...
	if( writePtnmemCtrlRegs((U08)SPICMD_Q_READ_STATUS_REGISTER) == 0x00 )
	{
			return 0x00;
	}
	...
	YVC_WritePort((U08)Y643_PORT_PTNMEM_READACS, (0x10U));
	...
	} while ((((u08ReadData[0] & u08DataMask[0]) != 0U) || ((u08ReadData[1] & u08DataMask[1]) != 0U)) && (bRet == 0x01));
	return bRet;
}
...
static void writeStatusRegCommand(U32 Addr, U08 SpiCmd, U08 Data)
{
	...
	if( writePtnmemCtrlRegs(SpiCmd) == 0x00 )
	{
			return ;
	}
	...
	for(u08Cnt=0U; u08Cnt<u08DataNum; u08Cnt++)
	{
		...
		YVC_WritePort((U08)Y643_PORT_PTNMEM_DATA, u08Data[u08Cnt]);
...
static void readPtnmemDataPort(U08 *Data)
{
	...
	u08Data = YVC_ReadPort((U08)Y643_PORT_PTNMEM_READACS);
	u08Data |= (0x80U);
	YVC_WritePort((U08)Y643_PORT_PTNMEM_READACS, u08Data);

	 
	waitClearFlag((0x80U));

	 
	*Data = YVC_ReadPort((U08)Y643_PORT_PTNMEM_DATA);
}
...
static void writeEnableCommand(U32 Addr)
{
	...
	if( writePtnmemCtrlRegs((U08)SPICMD_Q_WRITE_ENABLE) == 0x00 )
	{
			return ;
	}
	...
	for(u08Cnt=0U; u08Cnt<u08DataNum; u08Cnt++)
	{
		...
		YVC_WritePort((U08)Y643_PORT_PTNMEM_DATA, 0x00U);
