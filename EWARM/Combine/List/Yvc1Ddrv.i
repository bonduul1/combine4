...
BOOL YVC1_WriteReg(U08 RegNo, U08 Data)
{
	...
	if (bRet == 0x01)
	{
		...
		tY643PortPtnMem.BIT.RGN_7 = ((RegNo >> (7)) & (0x01U));
		tY643PortRegSel.BIT.RGN_0 =  (RegNo                 & (0x7FU));
		YVC_WritePort(Y643_PORT_PTNMEM_READACS, tY643PortPtnMem . BYTE);
		YVC_WritePort(Y643_PORT_REG_SEL, tY643PortRegSel . BYTE);
		YVC_WritePort(Y643_PORT_REG_DATA, Data);
...
BOOL YVC1_ReadReg(U08 RegNo, U08 *Data)
{
	...
	if (bRet == 0x01)
	{
		...
		YVC_WritePort(Y643_PORT_PTNMEM_READACS, tY643PortPtnMem . BYTE);
		YVC_WritePort(Y643_PORT_REG_SEL, tY643PortRegSel . BYTE);
		*Data = (U08)YVC_ReadPort(Y643_PORT_REG_DATA);
...
BOOL YVC1_WriteRegs(U08 RegNo, const U08 *Buff, U08 Num)
{
	...
	if (bRet == 0x01)
	{
		...
		YVC_WritePort(Y643_PORT_REG_SEL, tY643PortRegSel . BYTE);
			...
			YVC_BurstWritePort(Y643_PORT_REG_DATA, Buff, Num);
...
BOOL YVC1_ReadTbls(U16 Addr, U08 *Buff, U16 Num)
{
	...
	else if(Addr < (0x2000U) + (512))
	{
		if((Addr + Num) > (0x2000U) + (512))
		{
			bRet = 0x00;
		}
	}
	 
	else if(((0x1000U) + (0x2000U) <= Addr) && (Addr < (0x1000U) + (0x2000U) + (512)))
	{
		if((Addr + Num) > (0x1000U) + (0x2000U) + (512))
		{
			bRet = 0x00;
		}
	}
	...
	if (bRet == 0x01)
	{
		...
		bRet = YVC1_WriteReg(REG_R28H, (U08)(Addr >> (8)));
		if (bRet == 0x01)
		{
			bRet = YVC1_WriteReg(REG_R29H, (U08)(Addr & (0xFFU)));
		}

		 
		if (bRet == 0x01)
		{
			bRet = YVC1_WriteReg(REG_R27H, 0x02);	 
		}
		...
		if (bRet == 0x01)
		{
				...
				YVC_BurstReadPort(Y643_PORT_GENTBL_DATA, Buff, Num);


			 
			bRet = YVC1_WriteReg(REG_R27H, 0);		 
		}
	}
...
BOOL YVC1_WriteTbls(U16 Addr, const U08 *Buff, U16 Num)
{
	...
	if (bRet == 0x01)
	{
		...
		if (bRet == 0x01)
		{
				...
				YVC_BurstWritePort(Y643_PORT_GENTBL_DATA, Buff, Num);
...
BOOL YVC1_ReadPlts(U16 Addr, U08 *Buff, U16 Num)
{
	...
	if (bRet == 0x01)
	{
		...
		bRet = YVC1_WriteReg(REG_R2AH, (U08)(Addr >> (8)));
		if (bRet == 0x01)
		{
			bRet = YVC1_WriteReg(REG_R2BH, (U08)(Addr & (0xFFU)));
		}

		 
		if (bRet == 0x01)
		{
			bRet = YVC1_WriteReg(REG_R27H, 0x01);	 
		}

		if (bRet == 0x01)
		{

				YVC_BurstReadPort(Y643_PORT_PLT_GAM_WRP_DATA, Buff, Num);
...
BOOL YVC1_WritePlts(U16 Addr, const U08 *Buff, U16 Num)
{
	...
	if (bRet == 0x01)
	{
		...
		if(bRet == 0x01)
		{
        		...
        		YVC_BurstWritePort(Y643_PORT_PLT_GAM_WRP_DATA, Buff, Num);
...
BOOL YVC1_ReadGamTbls(U16 Addr, U08 *Buff, U16 Num)
{
	...
	if (bRet == 0x01)
	{
		...
		bRet = YVC1_WriteReg(REG_R2AH, (U08)((Addr >> (8)) & (0x3FU)));
		if (bRet == 0x01)
		{
			bRet = YVC1_WriteReg(REG_R2BH, (U08)(Addr & (0xFFU)));
		}
		...
		{
			Buff[u16Count] = YVC_ReadPort(Y643_PORT_PLT_GAM_WRP_DATA);
		}

		 
		bRet = YVC1_WriteReg(REG_R27H, 0x00);  
	}
...
BOOL YVC1_WriteGamTbls(U16 Addr, const U08 *Buff, U16 Num)
{
	...
	if (bRet == 0x01)
	{
		...
		for (u16Count=0; u16Count<Num ;u16Count++)
		{
			YVC_WritePort(Y643_PORT_PLT_GAM_WRP_DATA, Buff[u16Count]);
		}
...
BOOL YVC1_ReadWrpTbls(U16 Addr, U08 *Buff, U16 Num)
{
	...
	if (bRet == 0x01)
	{
		...
		bRet = YVC1_WriteReg(REG_R2AH, (U08)((Addr >> (8)) & (0x7FU)));
		if (bRet == 0x01)
		{
			bRet = YVC1_WriteReg(REG_R2BH, (U08)(Addr & (0xFFU)));
		}
...
BOOL YVC1_DmaInit(const T_YVC1_DMA_INIT *tYvc1DmaInit)
{
	...
	if (tYvc1DmaInit == (const T_YVC1_DMA_INIT*)((void *)0))
	{
		bRet = 0x00;
	}
	...
	if (bRet == 0x01)
	{
		...
		{	 
			...
			{	 
				if ( ((u16DESTAD > (0x1FFC)) || ((u16DESTAD % (4))!=0)) ||
					 ((u16BYTECNT > (8192)) || ((u16BYTECNT % (4))!=0)) )
				{
					bRet = 0x00;
				}
			}
	...
	if (bRet == 0x01)
	{
		...
		tY643RB0h.BIT.SOCEAD_24 = (U08)(( u32SOCEAD  >> (24) ) & (0x03U));
		tY643RB1h.BIT.SOCEAD_16 = (U08)(( u32SOCEAD  >> (16) ) & (0xFFU));
		tY643RB2h.BIT.SOCEAD_8  = (U08)(( u32SOCEAD  >> (8) ) & (0xFFU));
		tY643RB3h.BIT.SOCEAD_0  = (U08)(( u32SOCEAD                 ) & (0xFFU));
		tY643RB4h.BIT.DESTSEL   = u08DESTSEL;
		tY643RB4h.BIT.DESTAD_8  = (U08)(( u16DESTAD  >> (8) ) & (0x1FU));
		tY643RB5h.BIT.DESTAD_0  = (U08)(( u16DESTAD                 ) & (0xFFU));
		tY643RB6h.BIT.BYTECNT_8 = (U08)(( u16BYTECNT >> (8) ) & (0x3FU));
		tY643RB7h.BIT.BYTECNT_0 = (U08)(( u16BYTECNT                ) & (0xFFU));
...
BOOL YVC1_DmaCtrl(BOOL Enable)
{
	...
	do {
		...
		{
			u32Count++;
			if(u32Count > (300000UL))
			{
				bRet       = 0x00;
				bPlgMaxFlg = 0x01;
			}
		}
	}while( (bPlgFlg == 0x00) && (bPlgMaxFlg == 0x00) );

	 
	if( (bPlgFlg == 0x01) && (Enable == 0x01) )
	{
...
BOOL YVC1_Init(const T_YVC1_DATA *tYvc1Data)
{
	...
	if( (tYvc1Data == (T_YVC1_DATA*)((void *)0)) ||
	    ((0x0204U) > (4080)) ||
	    ((0x0204U) % (12) != 0) ||
	    ((150)  > (341)) ||
	    (((0x0204U) + ((150) * (12))) > (4092)) )
	...
	if (bRet == 0x01)
	{
		...
		if ( ((tYvc1Data->Clk[0] & (0xF8U)) == 0x00) &&
			 ((tYvc1Data->Clk[1] & (0x7FU)) == 0x00) )
		{
			...
			if (bRet == 0x01)
			{
				...
				{														 
					...
					if ( (bRet1 == 0x01) && (bRet2 == 0x01) && (bRet3 == 0x01) )
					{
						bRet = 0x01;
					}
					else
		...
		else
		{
			...
			if (bRet == 0x01)
			{
				bRet1 = s_WriteRegPll(REG_R01H, tYvc1Data->Clk[0]);		 
				...
				if (bRet == 0x01)
				{
					bRet = s_WriteRegPll(REG_R00H, (0x80));			 
					if (bRet == 0x01)
					{
						WaitMSec((4));			 
						bRet = s_INIENDWaitPolling();
						...
						{												 
							...
							if ( (bRet1 == 0x01) &&
								 (bRet2 == 0x01) && 
								 ((tYvc1Data->Clk[0] & (0xF8U)) == (u08PLL_R[0] & (0xF8U))) &&
								 ((tYvc1Data->Clk[1] & (0x7FU)) == (u08PLL_R[1] & (0x7FU))) )
							{
								bRet = 0x01;
							}
							else
		...
		if (bRet == 0x01)
		{
			...
			tY643R30h.BIT.EXLY    = (1);
			tY643R30h.BIT.ALPBSEL = (1);
			bRet5 = YVC1_WriteReg(REG_R30H, tY643R30h.BYTE);

			if((bRet4 == 0x01) && (bRet5 == 0x01))
			{
				bRet = 0x01;
			}
			else
		...
		if(bRet == 0x01)
		{
			...
			else
			{
				...
				u16LyrEndAddr   = (0x0204U) + ((150) - 1) * (12);
				

				tY643R3EH.BIT.LYSAC_8 = (((0x0204U) >> (8)) & (0x0FU));
				tY643R3FH.BIT.LYSAC_2 = (((0x0204U) >> (2)) & (0x3FU));
				tY643R40H.BIT.LYEAC_8 = ((u16LyrEndAddr    >> (8)) & (0x0FU));
				tY643R41H.BIT.LYEAC_2 = ((u16LyrEndAddr    >> (2)) & (0x3FU));
				bRet7  = YVC1_WriteReg(REG_R3EH, tY643R3EH.BYTE);
			...
			if( (bRet6 == 0x01) && (bRet7 == 0x01) && (bRet8 == 0x01) && (bRet9 == 0x01) && (bRet10 == 0x01))
			{
				bRet = 0x01;
			}
			else
...
BOOL YVC1_GetVer(U08 *DevVer, C08 *DrvVer)
{
	...
	if (bRet == 0x01)
	{
		...
		{
			c08p = ("0.8.0.1");
			for (u08Cnt=0; u08Cnt<sizeof(("0.8.0.1")); u08Cnt++)
			{
...
BOOL YVC1_FlipTbl(void)
{
	...
	if ((Reg3EHData & (0x40U)) != (0))
	{
		 
		Reg3EHData &= (U08)(~(0x40U));
	}
	else
	{
	...
	YVC_WritePort(Y643_PORT_FLG_STATUS1, tY643PortFlag1 . BYTE);

	 
	bRet9 = s_FBWait();

	if ( (bRet1 == 0x01) && (bRet2 == 0x01) && (bRet3 == 0x01) && (bRet4 == 0x01) &&
		 (bRet5 == 0x01) && (bRet6 == 0x01) && (bRet7 == 0x01) && (bRet8 == 0x01) &&
		 (bRet9 == 0x01) )
	{
		bRet = 0x01;
	}
...
static BOOL s_FBWait(void)
{
	...
	do
	{
		tY643PortFlag1.BYTE = YVC_ReadPort(Y643_PORT_FLG_STATUS1);
...
static BOOL s_INIENDWaitPolling(void)
{
	...
	do
	{
          ...
          data = YVC_ReadPort(Y643_PORT_PTNMEM_READACS);
...
static BOOL s_GeneralTblInit(void)
{
	...
	const U08 u08YvcLyrAttrData[(12)]  = {0x10U,0x00U,0x00U,0x00U,0x00U,0x00U,0x00U,0x00U,0x00U,0x00U,0x00U,0x00U};    
	const U08 u08YVC1ExLyrData[(1)] = {0x00U};  
	...
	for (u16Addr=(0x0000U); (u16Addr<((0x0000U) + ((341) * (12)))); u16Addr+=(12))
	{
		 
		bRet1 = YVC1_WriteTbls((u16Addr | (0x1000U)), &u08YvcLyrAttrData[0], (12));
		bRet2 = YVC1_WriteTbls( u16Addr,                          &u08YvcLyrAttrData[0], (12));

		 
		 
		u16ExAddr = (0x2000U) + (u16Addr / (8));
		bRet3 = YVC1_WriteTbls( u16ExAddr,                        &u08YVC1ExLyrData[0], (1));
		bRet4 = YVC1_WriteTbls((u16ExAddr|(0x1000U)), &u08YVC1ExLyrData[0], (1));
	}
...
static BOOL s_WriteRegPll(U08 RegNo, U08 Data)
{
	...
	if (bRet == 0x01)
	{
		...
		YVC_WritePort(Y643_PORT_REG_SEL, RegNo);
		WaitMSec(1);
...
static T_Y643_PORT_PTNMEM s_PtnMemReadAcs_Reg7_Data(void)
{
	...
	do {
		tY643PortPtnMem.BYTE = YVC_ReadPort(Y643_PORT_PTNMEM_READACS);
	...
	} while((tY643PortPtnMem.BIT.PMRREQ != 0) && (bPlgMaxFlg == 0x00));

	tY643PortPtnMem.BYTE &= (0x10U);
...
BOOL YVC1_GetChecksum(U32 startAddr, U32 endAddr , U16 *Checksum)
{
	...
	CSSA[0] = (U08)((startAddr >> (24)) );
	CSSA[1] = (U08)((startAddr >> (16)) );
	CSSA[2] = (U08)((startAddr >> (8)) );
	CSSA[3] = (U08)((startAddr               ) );

	
	CSEA[0]    = (U08)((endAddr >> (24)) );
	CSEA[1]    = (U08)((endAddr >> (16)) );
	CSEA[2]    = (U08)((endAddr >> (8)) );
	CSEA[3]    = (U08)((endAddr               ) );
...
{
	U16 u16bRet = 0;
	u16bRet = YVC_ReadPort(Y643_PORT_FLG_STATUS1);
	u16bRet = YVC_ReadPort(Y643_PORT_FLG_STATUS2) | (u16bRet << 8);
