...
uint8_t dma_adc_complete;                               
uint16_t adc_converter_counter;
 
uint32_t adcValue[5];                                      
uint32_t totalAdcValue[5][100];          
uint16_t adcAverageValue[5];                               
...
uint8_t startConversation()
{
  ...
  return HAL_ADC_Start_DMA(&hadc1, adcValue, 5);
}
...
uint8_t updateLastAverageADC()
{
  ...
  if(dma_adc_complete)
  {
    ...
    for(i = 0; i < 5; i++)
    {
      ...
      adcAverageValue[i] = (uint16_t)((float)temp / 100);
    }
    return 1;
  }  
  return 0;
...
void adc_init(void)
{
  ...
  sConfig.Channel = ((uint32_t)((0x08UL << (0U)) | (0x02UL << (0U))));
  sConfig.Rank = 1;
  sConfig.SamplingTime = ((uint32_t)(0x7UL << (0U)));
  ...
  sConfig.Channel = ((uint32_t)((0x08UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U))));
  sConfig.Rank = 2;
  if (HAL_ADC_ConfigChannel(&hadc1, &sConfig) != HAL_OK)
  {
    Error_Handler();
  ...
  sConfig.Channel = ((uint32_t)((0x08UL << (0U)) | (0x04UL << (0U))));
  sConfig.Rank = 3;
  if (HAL_ADC_ConfigChannel(&hadc1, &sConfig) != HAL_OK)
  {
    Error_Handler();
  ...
  sConfig.Channel = ((uint32_t)((0x08UL << (0U)) | (0x04UL << (0U)) | (0x01UL << (0U))));
  sConfig.Rank = 4;
  if (HAL_ADC_ConfigChannel(&hadc1, &sConfig) != HAL_OK)
  {
    Error_Handler();
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL)))
  {
    ...
    hdma_adc1.Init.PeriphDataAlignment = ((uint32_t)(0x2UL << (11U)));
    hdma_adc1.Init.MemDataAlignment = ((uint32_t)(0x2UL << (13U)));
