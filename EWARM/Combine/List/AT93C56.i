...
void init_93c56(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0010),  GPIO_PIN_RESET);
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0020),  GPIO_PIN_RESET);
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0080),  GPIO_PIN_RESET);
...
void shift_out_bit_93c56(uint8_t bit)
{
  ...
  if(bit == 0)
    ...
    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0080), GPIO_PIN_SET);  
  DWT_Delay_us(1);
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0010), GPIO_PIN_SET);
}
...
uint8_t shift_in_bit_93c56(void)
{
  ...
  DWT_Delay_us(1);
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0010), GPIO_PIN_SET);
  if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0040)) == GPIO_PIN_SET)
    return 1;
  else
    return 0;
}
...
void send_cmd_93c56(uint8_t opcode, uint8_t addr)
{
  ...
  __disable_interrupt();
  shift_out_bit_93c56(1); 
  temp_bits = ((uint16_t)(opcode << 8) | addr);
  temp_len = 8 + 2;                                      
  while(temp_len > 0){
    temp_len--;
...
void write_enable_93c56(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0020), GPIO_PIN_SET);
  send_cmd_93c56(0x00, (0x03<<(8-2)));
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0010), GPIO_PIN_RESET);
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0020), GPIO_PIN_RESET);
  DWT_Delay_us(1);
