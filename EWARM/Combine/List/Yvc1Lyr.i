...
BOOL YVC1_SetSprtAttr(U16 LyrId, const T_Y643_LYR_SPRTATTR *tY643LyrSprtAttr)
{
	...
	if( (LyrId >= (150)) ||
		(tY643LyrSprtAttr == (const T_Y643_LYR_SPRTATTR*)((void *)0)) )
	{
		bRet = 0x00;
	}
	...
	if (bRet == 0x01)
	{
		u16Addr = (U16)((0x0204U) + (U16)(LyrId * (12)));
		bRet1 = s_TblWrite(u16Addr, (const U08*)&tY643LyrSprtAttr->BYTE[0], (12));
...
BOOL YVC1_GetSprtAttr(U16 LyrId, T_Y643_LYR_SPRTATTR *tY643LyrSprtAttr)
{
	...
	{
		u16Addr = (U16)((0x0204U) + (U16)(LyrId * (12)));
		bRet1 = s_TblRead(u16Addr, &tY643LyrSprtAttr->BYTE[0], (12));
...
BOOL YVC1_SetFontAttr(U16 LyrId, const T_Y643_LYR_FONTATTR *tY643LyrFontAttr)
{
	...
	if( (LyrId >= (150)) ||
		(tY643LyrFontAttr == (const T_Y643_LYR_FONTATTR*)((void *)0)) )
	{
		bRet = 0x00;
	}
	...
	{
		u16Addr = (U16)((0x0204U) + (U16)(LyrId * (12)));
		bRet1 = s_TblWrite(u16Addr, (const U08*)&tY643LyrFontAttr->BYTE[0], (12));
...
BOOL YVC1_GetFontAttr(U16 LyrId, T_Y643_LYR_FONTATTR *tY643LyrFontAttr)
{
	...
	{
		u16Addr = (U16)((0x0204U) + (U16)(LyrId * (12)));
		bRet1 = s_TblRead(u16Addr, &tY643LyrFontAttr->BYTE[0], (12));
...
BOOL YVC1_SetFontTypAttr(U08 FontTypId, const T_Y643_FONT_TYPATTR *tY643FontTypAttr)
{
	...
	if( (FontTypId >= (8)) ||
		(tY643FontTypAttr == (const T_Y643_FONT_TYPATTR*)((void *)0)) )
	{
		bRet = 0x00;
	}
	...
	if (bRet == 0x01)
	{
		u16Addr = (U16)((0x0FD8) + (U16)(FontTypId * (8)));

		 
		bRet = s_TblWrite(u16Addr, &tY643FontTypAttr->BYTE[0], (8));
	}
...
BOOL YVC1_SetPCharCodes(U16 CharCodeId, const T_Y643_TEXT_PFONT *tY643TextPFont, U16 CharCodeNum)
{
	...
	if( (CharCodeId  >= ((0x0368)/4)) ||
		(tY643TextPFont == (const T_Y643_TEXT_PFONT*)((void *)0))||
		(CharCodeNum > ((0x0368)/4)) ||
		(CharCodeId + CharCodeNum > ((0x0368)/4)) )
	{
		bRet = 0x00;
	}
	...
	if (bRet == 0x01)
	{
		u16Addr = (U16)(((0x0C70)) + (U16)(CharCodeId * (4)));
		u16Num  = (U16)(CharCodeNum * (4));
...
{
	BOOL bRet           = 0x01;
	const T_YGFONT_TBL *ptYgfntTbl = (const T_YGFONT_TBL*)((void *)0);
	...
	if( (tYgfontData == (T_YGFONT_DATA*)((void *)0)) ||
		(Fcode    == (U16*)((void *)0)) )
	{
		bRet = 0x00;
	}
	...
	if (bRet == 0x01)
	{
		for(u16TblCnt = 0; ((u16TblCnt < u16YgfntTblNum) && (bValid == 0x00)); u16TblCnt++)
		{
...
BOOL YVC1_SetClipAttr(U16 LyrId, const T_Y643_LYR_CLIPATTR *tY643LyrClipAttr)
{
	...
	if( (LyrId >= (150)) ||
		(tY643LyrClipAttr == (const T_Y643_LYR_CLIPATTR*)((void *)0)) )
	{
		bRet = 0x00;
	}
	...
	{
		u16Addr = (U16)((0x0204U) + (U16)(LyrId * (12)));
		bRet = s_TblWrite(u16Addr, (const U08*)&tY643LyrClipAttr->BYTE[0], (12));
	}
...
BOOL YVC1_GetClipAttr(U16 LyrId, T_Y643_LYR_CLIPATTR *tY643LyrClipAttr)
{
	...
	{
		u16Addr = (U16)((0x0204U) + (U16)(LyrId * (12)));
		bRet = s_TblRead(u16Addr, &tY643LyrClipAttr->BYTE[0], (12));
	}
...
U08 YVC1_GetMacroStatus(void)
{
	...
	return YVC_ReadPort(Y643_PORT_FLG_STATUS2);
}
...
BOOL YVC1_PlayMacro(U32 u32SceneAddr)
{
	...
	u08SSA[0]    = (U08)((u32SceneAddr >> (24)) & (0x03U));
	u08SSA[1]    = (U08)((u32SceneAddr >> (16)) & (0xFFU));
	u08SSA[2]    = (U08)((u32SceneAddr >> (8)) & (0xFFU));
	u08SSA[3]    = (U08)((u32SceneAddr               ) & (0xFCU));
	bRet = YVC1_WriteRegs(REG_R5CH, &u08SSA[0], 4);
	if (bRet == 0x01)
	{
			 
		YVC_WritePort(Y643_PORT_FLG_STATUS2, 0x80);
...
BOOL YVC1_SetSprtAttrWithParam(U16 LyrId, const T_Y643_LYR_SPRTATTR *tY643LyrSprtAttr , S16 s16x , S16 s16y, U16 u16Alpha)
{
	...
	Doy = (S16)(tLyrSprtAttr.BIT.DOY_8) << (8);
	Doy |= tLyrSprtAttr.BIT.DOY_0;
	
	Dox = (S16)(tLyrSprtAttr.BIT.DOX_8) << (8);
	...
	tLyrSprtAttr.BIT.DOY_0 = (U08)(Doy               ) & (0xFFU);
	tLyrSprtAttr.BIT.DOY_8 = (U08)(Doy >> (8)) & (0x07U);
	
	tLyrSprtAttr.BIT.DOX_0 = (U08)(Dox               ) & (0xFFU);
	tLyrSprtAttr.BIT.DOX_8 = (U08)(Dox >> (8)) & (0x07U);
	
	tLyrSprtAttr.BIT.MX8  = (U08)(u16Alpha >> (8)) & (0x01U);
	tLyrSprtAttr.BIT.MX_4 = (U08)(u16Alpha >> (4)) & (0x0FU);
	
		tLyrSprtAttr.BIT.EXLY.MX_0 = (U08)(u16Alpha)&(0x0FU);
	...
	{
		u16Addr = (U16)((0x0204U) + (U16)(LyrId * (12)));
		bRet1 = s_TblWrite(u16Addr, (const U08*)&tLyrSprtAttr.BYTE[0], (12));
...
void YVC1_SetHostContLyrWithFlip(U16 u16LyrStartAddr,U16 NumofLayers)
{
	...
	tY643R3EH.BIT.LYSAC_8 = ((u16LyrStartAddr >> (8)) & (0x0FU));
	tY643R3FH.BIT.LYSAC_2 = ((u16LyrStartAddr >> (2)) & (0x3FU));
	
	tY643R40H.BIT.LYEAC_8 = (((u16LyrStartAddr+(NumofLayers-1)*(12)) >> (8)) & (0x0FU));
	tY643R41H.BIT.LYEAC_2 = (((u16LyrStartAddr+(NumofLayers-1)*(12)) >> (2)) & (0x3FU));
