...
void spi_init()
{
  ...
  hspi2.Init.BaudRatePrescaler = ((0x4UL << (3U)));
  hspi2.Init.FirstBit = (0x1UL << (7U));
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))
  {
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0400)|((uint16_t)0x4000)|((uint16_t)0x8000);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0400)|((uint16_t)0x4000)|((uint16_t)0x8000));
