...
uint8_t axelControlFunctionEnabled;                                             
...
void can_data_handler(CAN_RxHeaderTypeDef *rxHeader, uint8_t *rx_data)
{
  ...
  else if(rxHeader->ExtId == 0x19FFC025)
  {
    timer_data_025 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFC035)
  {
    timer_data_035 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA310)
  {
    timer_data_310 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA311)
  {
    timer_data_311 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA312)
  {
    timer_data_312 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA317)
  {
    timer_data_317 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA330)
  {
    timer_data_330 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA331)
  {
    timer_data_331 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA332)
  {
    timer_data_332 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA340)
  {
    timer_data_340 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA350)
  {
    timer_data_350 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA360)
  {
    timer_data_360 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA381)
  {
    timer_data_381 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA390)
  {
    timer_data_390 = 0;
    for(i = 0; i < 8; i++)
    {
  ...
  else if(rxHeader->ExtId == 0x19FFA329)
  {
...
void can_receive_process()
{
  ...
  if(timer_data_025 > 2000)
  {
    flagWarning.can_timeout_warning_025 = 1;
  }
  else
  {
    timer_data_025++;
    flagWarning.can_timeout_warning_025 = 0;
  }
  
  if(timer_data_035 > 2000)
  {
    flagWarning.can_timeout_warning_035 = 1;
  }
  else
  {
    timer_data_035++;
    flagWarning.can_timeout_warning_035 = 0;
  }
  
  if((timer_data_310 > 2000) || (timer_data_311 > 2000) || (timer_data_312 > 2000) || (timer_data_317 > 2000))
  {
    flagWarning.can_timeout_warning_31x = 1;
  }
  else
  {
    timer_data_310++;
    ...
    timer_data_312++;
    timer_data_317++;
    flagWarning.can_timeout_warning_31x = 0;
  }
  
  if((timer_data_330 > 2000) || (timer_data_331 > 2000) || (timer_data_332 > 2000))
  {
    flagWarning.can_timeout_warning_33x = 1;
  }
  else
  {
    timer_data_330++;
    timer_data_331++;
    timer_data_332++;
    flagWarning.can_timeout_warning_33x = 0;
  }
  
  if(timer_data_340 > 2000)
  {
    flagWarning.can_timeout_warning_340 = 1;
  }
  else
  {
    timer_data_340++;
    flagWarning.can_timeout_warning_340 = 0;
  }
  
  if(timer_data_350 > 2000)
  {
    if(modelSelection == 2)
    {
      flagWarning.can_timeout_warning_381 = 0;
    }
    else
    {
      flagWarning.can_timeout_warning_350 = 1;
    }
  }
  else
  {
    timer_data_350++;
    flagWarning.can_timeout_warning_350 = 0;
  }

  if(axelControlFunctionEnabled == 0)
  {
    if(timer_data_360 > 2000)
    {
      flagWarning.can_timeout_warning_360 = 1;
    }
    else
    {
      timer_data_360++;
      flagWarning.can_timeout_warning_360 = 0;
    }  
  }
  
  if(timer_data_381 > 2000)
  {
    if(modelSelection == 2)
    {
      flagWarning.can_timeout_warning_381 = 0;
    ...
    {
      flagWarning.can_timeout_warning_381 = 1;
    }
  }
  else
  {
  ...
  if(timer_data_390 > 2000)
  {
    flagWarning.can_timeout_warning_390 = 1;
  }
  else
  {
    timer_data_390++;
    flagWarning.can_timeout_warning_390 = 0;
  }
  ...
  if(axelControlFunctionEnabled == 0)
  {
    ...
    if(((dataCAN360.data[0] >> 4) & 0x0F) == 0x00)                     
    { 
    ...
    else if(((dataCAN360.data[0] >> 4) & 0x0F) == 0x0A)                
    {
      can_341_data[10]          = axel_threshing_rpm            = (dataCAN360.data[2] << 8) + dataCAN360.data[3];
    }
    else if(((dataCAN360.data[0] >> 4) & 0x0F) == 0x0F)                
    {
...
void can_transmit_tsc1_packet()
{
  ...
  can_transmit(1, 0x0C0000FE, data);
}
...
void can_transmit_ecr1_packet()
{
  ...
  can_transmit(1, 0x0CFF02FE, data);
}
...
void can_transmit_packet()
{
  ...
  can_transmit(2, 0x19FFA320, data);
}
...
void can_transmit_setting()
{
  ...
  can_transmit(2, 0x19FFA000 | setup_mode_address, data);
}
...
void can_transmit_axel()
{
  ...
  can_transmit(2, 0x19FFA360, data);
}
...
void can_transmit_diagnostic()
{
  ...
  can_transmit(2, 0x19FFD020, data);
}
...
void can_transmit_process()
{
  ...
  else if(timerAxel >= 125)
  {
    timerAxel = 0;
    if(axelControlFunctionEnabled == 1)
    {
      can_transmit_axel();
    }
  }
  else if(timerSetting >= 500)
  {
    timerSetting = 0;
    if(setup_mode == 2)
    {
...
uint8_t can_transmit(uint8_t channel, uint32_t id, uint8_t _data[])
{
  ...
  {
    canTwoTxHeader.IDE = (0x00000004U);
    canTwoTxHeader.RTR = (0x00000000U);
...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
  ...
  {
    if (HAL_CAN_GetRxMessage(hcan, (0x00000000U), &canTwoRxHeader, canTwoRxData) != HAL_OK)
    {
...
void MX_CAN2_Init(void)
{
  ...
  hcan2.Init.SyncJumpWidth = ((uint32_t)(0x1UL << (24U)));
  hcan2.Init.TimeSeg1 = ((uint32_t)(0x4UL << (16U)));
  hcan2.Init.TimeSeg2 = ((uint32_t)(0x1UL << (20U)));
  ...
  if(HAL_CAN_ActivateNotification(&hcan2, ((uint32_t)(0x1UL << (1U)))) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_CAN_MspInit(CAN_HandleTypeDef* hcan)
{
  ...
  else if(hcan->Instance==((CAN_TypeDef *) (0x40000000UL + 0x6800UL)))
  {
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x2000)|((uint16_t)0x0020);
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x0UL << 4U));
    GPIO_InitStruct.Pull = 0x00000000U;
    GPIO_InitStruct.Speed = 0x00000003U;
    GPIO_InitStruct.Alternate = ((uint8_t)0x09);
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  ...
  else if(hcan->Instance==((CAN_TypeDef *) (0x40000000UL + 0x6800UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x2000)|((uint16_t)0x0020));
