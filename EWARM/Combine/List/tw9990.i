...
{
  WriteI2C(0x88, _addr, _val);
}

uint8_t ReadTW99(uint8_t _addr)
{
  return ReadI2C(0x88, _addr);
}
...
void CheckSTB(void)
{
  ...
  WriteTW99(0xAF, 0x04);			
  STB = ReadTW99(0xB6);
  while (((STB & 0x80) == 0x80) && (0 == 1)){
    STB = ReadTW99(0xB6);
  }

  WriteTW99(0xAF, 0x10);			
  STG = ReadTW99(0xB6);
  while ((STG & 0x80) == 0x80 && (0 == 1)){
    STG = ReadTW99(0xB6);
  }
...
void InitRegisterSet(void)
{
  ...
  EncoderID = ReadI2C(ADV793xI2CAddress, 0x00);				
...
{ 
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x4000), GPIO_PIN_RESET);
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x8000), GPIO_PIN_SET);
   
  user_delay(5);
      
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x4000), GPIO_PIN_SET);
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x8000), GPIO_PIN_RESET);
...
void tw9990_init()
{
  ...
  GPIO_InitStructure.Pin = ((uint16_t)0x2000);
