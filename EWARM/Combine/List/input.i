...
uint8_t input_flags[11];
uint16_t input_timers[11];

GPIO_TypeDef* input_ports[11] = 
{ 
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), 
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), 
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), 
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)),   
...
uint8_t read_tail_light()
{
  if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x1000)) == GPIO_PIN_SET)
    return 0;                                                           
  else               
    return 1;
}
...
void read_inputs()
{
  ...
  flagInput.rightLamp = input_flags[0];
  flagInput.leftLamp = input_flags[1];
  flagInput.tailLamp = input_flags[3];
  
  flagInput.charge = (input_flags[2] == 1) ? 0 : 1;
  
  flagInput.oilPressure = (input_flags[4] == 1) ? 0 : 1;
  flagInput.grain_1 = (input_flags[5]== 1) ? 0 : 1;
  flagInput.grain_2 = (input_flags[6]== 1) ? 0 : 1;
  flagInput.grain_3 = (input_flags[7]== 1) ? 0 : 1;
  flagInput.grain_4 = (input_flags[8]== 1) ? 0 : 1;
  flagInput.buzzerStop = (input_flags[9]== 1) ? 0 : 1;
  flagInput.waterTemperature = (input_flags[10] == 1) ? 0 : 1;
}
