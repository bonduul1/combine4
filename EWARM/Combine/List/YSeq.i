...
static const T_YSEQ_DATA *g_pYSeqData       = (const T_YSEQ_DATA*)((void *)0);
static const T_YSEQ_INFO *g_pYSeqInfo       = (const T_YSEQ_INFO*)((void *)0);
static const T_YSEQ_BUTTON *g_ptYSeqButton0 = (const T_YSEQ_BUTTON*)((void *)0);
static S16 g_s16YSeqID       = 0;
static U08 g_u08ButtonAction = (0);
...
BOOL YSEQ_Init(const T_YSEQ_DATA *tYSeqData)
{
	...
	U16 u16Cnt   = 0;
	BOOL bGetFlg = 0x00;
	const T_YSEQ_INFO *ptYSeqInfo = (const T_YSEQ_INFO*)((void *)0);

	 
	 
	 
	if (tYSeqData == (const T_YSEQ_DATA*)((void *)0))
	{
		bRet = 0x00;
	}
	...
	if (bRet == 0x01)
	{
		...
		g_pYSeqInfo = (const T_YSEQ_INFO*)((void *)0);

		 
		ptYSeqInfo  = (const T_YSEQ_INFO*)(tYSeqData->tYSeqInfo);
		for(u16Cnt=0;(u16Cnt<(tYSeqData->YSeqInfoNum)) && (bGetFlg==0x00);u16Cnt++)
		{
...
BOOL YSEQ_Sequencer(S16 X, S16 Y, S16 Event, S16 *NextYSeqID, S16 *ButtonId)
{
	const T_YSEQ_BUTTON *ptYSeqButton = (const T_YSEQ_BUTTON*)((void *)0);
	BOOL bRet                         = 0x01;
	BOOL bExe                         = 0x00;
	BOOL bDataSetFlg                  = 0x00;
	...
	if ( (NextYSeqID == (S16*)((void *)0)) ||
		 (g_pYSeqData == (const T_YSEQ_DATA*)((void *)0)) ||
		 (ButtonId == (S16*)((void *)0)) )
	{
		bRet = 0x00;
	}
	...
	if (bRet == 0x01)
	{
		...
		*NextYSeqID     = (-1);
		...
		if (g_pYSeqInfo == (const T_YSEQ_INFO*)((void *)0))
		{
		...
		else
		{
			...
			if (g_pYSeqInfo->YSeqButtonNum != 0)
			{
				...
				for (u16YSeqButtonId=0; (u16YSeqButtonId<u08YSeqButtonNum) && (bExe==0x00); u16YSeqButtonId++)
				{
						 ...
						 (ptYSeqButton[u16YSeqButtonId].Y2 >= Y) )
					{
						...
						*ButtonId = (S16)((ptYSeqButton - g_ptYSeqButton0) + u16YSeqButtonId);
						...
						case (1):
						case (3):
							if ( (s16YSeqButtonEvent == (1)  ) ||
								 (s16YSeqButtonEvent == (3)) )
							{
								if (s16YSeqButtonEvent == (1))
								{
			...
			if ( (*NextYSeqID == (-1)) && 
				 ((YVC_ReadPort(Y643_PORT_FLG_STATUS2) & (0x80)) != 0) )
			{
...
BOOL YSEQ_SetIndex(S16 YSeqID)
{
	...
	if (g_pYSeqData == (const T_YSEQ_DATA*)((void *)0))
	{
		bRet = 0x00;
	}
	else
	...
	if (bRet == 0x01)
	{
		...
		bRet = YVC1_WriteReg(REG_R60H, (0x08));
		if (bRet == 0x01)
		{
			do {
			...
			} while (((u08RegR60 & (0x08)) != 0) && (bRet == 0x01));
		}
